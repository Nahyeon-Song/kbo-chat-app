...
### 제20조 경기중지에 따른 입장요금 처리 (제1장 KBO 정규시즌)
...
|삼성|이종열|단장|신동걸|팀장|신동걸|팀장|허준환|코치|유재형|프로|
|LG|차명석|단장|이진녕|팀장|최진영|팀장|박종곤|코치|임형길|책임|
|두산|김태룡|단장|김승호|실장|박정환|선임|홍성대|수석|김준수|선임|
|KT|나도현|단장|조찬관|팀장|조찬관|팀장|강권민|트레이너|이정훈|과장|
|SSG|김재현|단장|신민철|팀장|신민철|팀장|길강남|코치|박진우|매니저|
|롯데|박준혁|단장|임채우|팀장|권영준|매니저|조동관|코치|강윤식|매니저|
|한화|손 혁|단장|김장백|팀장|김장백|팀장|이지풍|코치|박건후|사원|
|NC|임선남|단장|민동근|팀장|민동근|팀장|조대현|트레이너|김동규|매니저|
|키움|고형욱|단장|허승필|팀장|허승필|팀장|양상봉|팀장|이준호|사원|



### 자동 투구 판정 시스템(ABS) 규정 (제7장 KBO 퓨처스리그)

심판판정의 공정성, 일관성, 정확성 향상을 위해 아래 규정에 의거하
여 자동 투구 판정 시스템(이하 “ ABS ” )을 도입하고, 주심의 볼·스트
라이크 판정을 대체한다.

1. ABS 적용 대상 경기
① KBO가 승인한 ABS 장비와 시스템이 설치된 구장에서 개최되
는 KBO 리그 경기(시범경기, 정규시즌, 올스타전, 포스트시즌
등)를 대상으로 실시한다.
② KBO는 승인된 대상 경기에서 ABS 판정 결과를 적용하여 투수
의 정규-투구에 대한 볼·스트라이크 판정(타자가 투구에 스윙
한 경우, 체크스윙 등 제외)을 대체한다.
③ KBO가 승인한 ABS 장비와 시스템이 구장에 설치되지 않았거
나 심판이 판단하기에 원활한 운영이 불가능해진 경우 심판은
양 구단 감독에게 이를 즉시 알리고, 해당 경기에서는 ABS 판
정 결과를 적용하지 않고 주심의 판단에 따른 볼·스트라이크
판정으로 운영하며 주심의 판정을 최종으로 한다.
2. ABS 운영
① KBO는 ABS의 운영을 총괄하고 시행세칙을 결정한다.
② ABS 스트라이크 존의 적용 기준은 실행위원회 의결에 따라 결
정한다.
③ 선수단과 구단은 원활한 ABS 운영이 이루어질 수 있도록 적극
협조하여야 한다.
④ ABS 판정 결과는 최종적이고 양 구단에 적용되며 이는 검토나
수정의 대상이 아니다. ABS 판정에 대해 선수단 및 양 구단 관


계자는 이의를 제기할 수 없다.
⑤ 선수단 또는 구단 관계자가 원활한 ABS 운영에 방해가 되거나
방해할 목적으로 경기운영에 지장을 주는 행위를 하는 경우 해
당 선수 또는 관계자는 즉시 퇴장당한다.
⑥ 벤치 및 그라운드에서의 전자기기 등 정보기기 사용 금지 규정
에도 불구하고, 선수단 또는 구단 관계자는 KBO가 제공하는 전
자기기(태블릿)를 ABS 판정 관련 데이터 확인 및 의견 수렴 목
적으로 사용할 수 있다. 단, 불공정 정보 입수, 경기진행 방해
등 다른 목적으로 사용할 수 없으며 태블릿에 제공하는 ABS 관
련 데이터를 외부로 유출해서는 안 된다.
⑦ 선수단 또는 구단 관계자가 본 규정에 명시된 사항을 위반할
경우 총재는 경고 처분, 제재금 부과, 출장정지 등 적절한 제재
를 부과할 수 있다.
3. ABS 운영요원은 매 경기시작 4시간 전 구장에 도착해 장비, 시스템
에 대한 점검을 실시한다. 경기 전 또는 경기 중 장비 결함, 오류,
기타 불가항력적인 상황 등으로 원활한 ABS 운영이 불가능한 경우
ABS 운영요원은 즉시 KBO와 심판진에 이를 통보하며, 주심의
볼·스트라이크 판정으로 대체 운영이 필요할 경우 심판진은 양
구단 감독에게 이를 최대한 즉시 통보하고 경기를 진행한다.
4. 경기 중 심판이 ABS 운영에 문제가 있다고 판단할 경우 심판은 즉
시 볼 데드 선언(단, 심판이 명백한 시스템의 오류라고 판단할시
심판 자체 판정 가능) 및 경기중단 후 ABS 운영요원과 소통하여
문제를 확인하도록 한다. 심판과 ABS 운영요원의 판단 하에 경기
에 지장 없이 단순 복구, 해결이 가능한 경우 ABS 복구 후 경기를
재개한다. 이때 최대 중단 시간은 5분으로 한다. 또한 ABS 운영이
중단된 이후 장비, 시스템이 다시 복구되어 원활한 ABS 운영이 가
능하다고 ABS 운영요원과 심판진이 판단하는 경우 다음 이닝 교대
시부터 심판진이 양 구단 감독에게 이를 통보한 후 ABS 운영을 재


개할 수 있다.
5. ABS 판정 이전, 도중, 이후 후속 플레이가 이어져 진행되는 경우에
는 해당 후속 플레이에 대한 최종 심판판정 결과가 나올 때까지 볼
인플레이 상황으로 진행되며, 이후 최종 ABS 판정 또는 심판판정
결과에 따라 심판팀장은 ABS 판정이 처음부터 즉시 옳은 볼·스트
라이크 판정이 이루어졌을 경우를 가정하고 양 구단이 위치해야 할
상황을 만들도록 한다. 이때 심판팀장은 공식야구규칙에 의거하여
필요한 주자 재배치, 재구성, 이닝 종료, 득점 인정, 무효화 등을
결정한다. 이에 대한 심판팀장의 결정은 최종이며 양 구단에 구속
력을 갖는다. 이에 대해 논란하거나 항의하는 감독 및 구단 관계자
에게는 퇴장을 명한다.
(2024.1.24 신설)


### 경기의 스피드업 (제7장 KBO 퓨처스리그)
...
금 등의 제재를 부과할 수 있다. 경기 중 적용되는 시간 제한 등
의 피치클락과 관련된 규정은 <KBO 피치클락 규정>에서 별도로
다룬다.
(2021.3.16, 2024.1.24 개정)
1. 구단
...
공이 투구될 때까지 걸리는 시간은 2분 10초로 한다. 이닝
교대시간 1분 30초가 경과된 후 주심이 투수와 포수, 대기
타석에 있는 타자에게 수신호로 마지막 연습투구라는 최종
시그널을 준다.
...
이며, 각 방문 시간은 30초로 제한한다.
(2001.7.16, 2003.11.26, 2018.3.22 감독자 합의,
2021.3.16, 2023.1.26, 2024.1.24 개정)
...
### KBO 피치클락 규정 (제7장 KBO 퓨처스리그)

<경기의 스피드업>과 함께 경기장 내 카운트다운 타이머(이하 “ 피치
클락 ” )를 이용해 경기진행 속도를 향상시키기 위해 본 피치클락 규정
을 적용한다.
※ KBO 리그에서는 투수판 이탈 제한이 없으며, 투수판 이탈에 해당
하는 행위를 하는 경우 피치클락은 재설정된다.
※ 퓨처스리그에서는 타석간 30초, 투구간(주자 없을 때) 18초, 투구
간(주자 있을 때) 23초, 타석간 30초가 적용되며, 본 규정 전체에서
33초 대신 30초, 20초 대신 18초, 25초 대신 23초를 적용한다. 타
자의 타임 요청은 1회 허용된다.

|클락은 다음과 같이 계측이 시작된다.|Col2|
|---|---|
|상황|시작 시간|
|투구간 (주자 없을 때)|20초|
|투구간 (주자 있을 때)|25초|
...
투수는 피치클락의 시간이 만료되기 전까지 타자에게 투구하는 자연
스러운 동작을 시작해야 한다. 피치클락이 만료되기 전에 투수가 투
구 동작에 들어갈 수 있도록 포수는 피치클락의 잔여시간이 9초가 남
은 시점까지 포수석에 위치해야 하며, 타자는 8초 남았을 때까지 양
발을 타석 안에 두고 타격준비자세를 취해야 한다(예 : 투수를 바라보
고 곧바로 타격을 취할 수 있는 자세). 투수, 타자, 또는 포수가 이를


위반할 경우 “ 1. ④ 제재 ” 에 따른 제재를 부과한다.
이닝 교대 또는 투수교체 이후의 첫 투구를 제외하고, 투수는 타자가
타석에 입장해 타격준비자세를 취한 이후에 투구 동작을 시작할 수
있다.
경기의 첫 번째 투구에는 피치클락이 적용되지 않으며, 두 번째 투구부
터 적용이 시작된다. 심판은 예정된 시간에 경기를 개시할 수 있도록
반드시 충분한 여유를 갖고 홈 플레이트 앞에 위치하고 있어야 한다.
1. 피치클락의 운영
KBO는 경기에서 피치클락을 제어할 계시원을 고용 및 배정한다.
심판은 이닝 교대 관리 등 경기의 모든 운영과 관리에 대한 전적인
책임과 권한이 있다.
① 투구간 시간 [25초 또는 20초]
타석의 초구를 제외하고, 피치클락은 주자 있을 때 25초, 주자
없을 때 20초에서 계측을 시작한다.
a. 계측 시작 : 투수가 공을 소유하고, 홈 플레이트 주위의
흙으로 뒤덮인 원(이하 “ 더트써클 ” ) 내에 포수
와 타자가 위치했을 때 시작
인플레이 상황인 타석의 각 투구 이후, 투수가
공을 소유하고, 포수와 타자가 더트써클 안에
위치하고, 플레이를 시작할 준비가 되었을 때
계측이 시작된다(예 : 모든 주자가 점유했던 베
이스로 귀루했거나, 루상에서 물러나게 되어
경기장에서 떠났을 때).
b. 계측 종료 : 투구 동작이 시작되었을 때 종료
투수가 타자에게 투구하는 자연스러운 동작을
시작할 때 계측이 종료된다(빈 화면 송출).
② 타석간 시간 [33초]
a. 계측 시작 : 직전 상황의 플레이가 종료되었을 때 시작
직전 상황의 결과로 이닝이 종료된 경우를 제


외하고, 타석간 시간은 세이프 또는 아웃에 대
한 심판의 최종 판정이나, 또는 플레이가 종료
되었다는 다른 명확한 표시를 계시원이 전달받
았을 때 계측이 시작된다.

[주] 타자주자가 2루에서 타석을 마쳐 보호장비
를 주루코치 및 배트보이/걸에게 전달해야
하는 경우 계측은 타자주자가 장비를 주루
코치 및 배트보이/걸에게 건넨 순간 시작
된다.
b. 계측 종료 : 투구 동작이 시작되었을 때 종료
투수가 타자에게 투구하는 자연스러운 동작을
시작할 때 계측이 종료된다(빈 화면 송출).
...
a. 계측 시작
(i) 이닝 교대 시간 [2분 10초]
: 이닝의 마지막 아웃이 선언되었을 때 시작
이닝이 종료되는 플레이가 종료되면, 주심은 양 팀 감
독의 비디오 판독 요청 여부를 확인한다. 양 팀 감독이
주심에게 판독 요청을 고려하고 있음을 알리지 않으면,
심판은 계시원에게 계측을 시작하라는 신호를 보내고
이닝 교대 시간 계측을 시작한다. 평범한 아웃 또는 비
디오 판독 대상이 아닌 판정의 경우 계시원은 세 번째
아웃 판정 직후 즉시 계측을 시작하여 이닝 교대를 개
시한다.
(ii) 투수교체 시간 [2분 10초]
: 구원투수가 워닝 트랙을 넘어설 때 시작
새로운 투수가 이닝을 시작하거나 이닝 도중 투수교체
...
원은 구원투수가 워닝 트랙을 밟았을 때 시간이 2분 10
초보다 적게 남았다면 2분 10초에서 다시 계측을 시작
...
시작하라는 신호를 보내야 한다.
b. 광고 송출 시간 보장
이닝 교대 또는 투수교체 후 첫 번째 투구의 경우 적절한 광
고 송출이 완료되는 것을 보장하기 위해, 투수는 이닝 교대
또는 투수교체 종료 시점까지 잔여시간이 20초보다 많이 남
았을 때는 투구를 위한 동작을 시작해서는 안 된다.

[주] 타자가 타석에 위치해 타격준비자세를 취하고 있고, 잔여
시간이 20초 이하인 경우 광고 송출이 완료되지 않았다
...
시작할 때 계측이 종료된다(빈 화면 송출).
④ 제재
투수, 타자, 포수의 피치클락 규정 위반에 대하여 아래의 제재
가 부과된다.


a. 투수 : 자동 볼
투수는 타자가 타석에 입장해 투수를 향해 타격준비
자세를 취한 이후 타자에게 투구하는 자연스러운 동
작을 시작해야 한다. 투수가 피치클락의 시간이 만료
되기 전에 투구 동작을 시작하지 않거나, 견제 또는
본 규정에 따라 허용되는 기타 투수판 이탈 행위를
하지 않으면 투수는 피치클락 규정 위반으로 심판에
의해 볼이 선언된다. 이때 볼 데드 상황이 되며, 심
판이 선언한 볼이 네 번째 볼로서 공식야구규칙
5.05(b)에 따라 타자가 1루로 진루하는 상황 외에는
어떠한 주자도 진루할 수 없다.

[주] 타자가 투수의 투구 동작을 방해하지 않았음에도 투수
가 동작에 들어간 이후 공을 타자에게 투구하는데 실패
...
세 차례(퓨처스리그 두 차례) 이상 타임을 요청하면, 타
자에게 피치클락 규정 위반이 적용되며, 심판은 스트라
이크를 선언한다. 또한 피치클락의 잔여시간이 8초 이
하가 남아있는 상태에서 타자가 타임 요청에 대한 심판


의 승인 없이 타석 밖으로 이탈한 경우에도 심판은 스트
라이크를 선언한다. 단, 타자가 세 번(퓨처스리그 두 번)
이상 타임을 요청하였더라도 타석을 벗어나지 않았다
면, 심판은 스트라이크를 선언하지 않고 타임 요청을 거
부할 수 있다.
c. 포수 : 자동 볼
이닝 교대 또는 투수교체 시간이 적용되고 있을 때,
피치클락의 잔여시간이 9초가 남은 시점까지 투수가
연습투구를 마치고 포수는 포수석에 위치해야 한다.
타석간 또는 투구간 시간의 경우에도 포수는 피치클
락의 잔여시간이 9초가 남은 시점까지 포수석에 위
치해야 한다. 이를 위반하는 경우 수비팀은 피치클락
규정 위반으로 심판에 의해 곧바로 볼이 선언된다.
이때 볼 데드 상황이 되며, 심판이 선언한 볼이 네
번째 볼로서 공식야구규칙 5.05(b)에 따라 타자가 1
루로 진루하는 상황 외에는 어떠한 주자도 진루할 수
없다.

[주] 피치클락의 잔여시간이 9초 미만일 때 포수가 포수석을
떠나 수비 신호를 보내고자 할 경우 포수가 심판에게 타
임을 요청하고 그 요청이 받아들여져야 한다. 퓨처스리
그에서는 이때 투수에게 투수판 이탈 1회가 부과된다.
d. 피치클락 규정 회피 시도
수비팀의 선수나 감독·코치가 고의로 이 규정의 적용을 모
면하거나 회피하려고 했다고 심판이 판단한 경우 볼이 선언
된다. 공격팀의 선수나 코치가 고의로 이 규정의 적용을 모
면하거나 회피하려고 했다고 심판이 판단한 경우 스트라이
크가 선언된다. 볼 또는 스트라이크의 선언 이후에는 볼 데
드 상황이 되며, 심판이 선언한 볼이 네 번째 볼로서 공식야


구규칙 5.05(b)에 따라 타자가 1루로 진루하는 상황 외에는
어떠한 주자도 진루할 수 없다.
총재는 선수와 코칭스태프, 구단 관계자의 피치클락 규정 회
피 시도에 대해 구단에게 제재를 부과할 수 있다.
2. 피치클락 관련 세칙
※ KBO 리그에서는 투수판 이탈 제한이 없으며, 투수가 투수판 이
탈에 해당하는 행위를 하는 경우 피치클락은 재설정된다. 투수
판 이탈 제한은 퓨처스리그에서 적용된다.
① 투수판 이탈 제한(견제, 투수판에서 발 빼기 등)
투수가 루상의 주자에 대해 견제를 시도하거나, 견제구를 던지
는 시늉을 하거나, 주자가 있을 때 투수판에서 발을 빼는 경우
투수에게 “ 투수판 이탈 ” 이 부과된다. 피치클락의 잔여시간이 9
초 미만이 남았을 때 포수가 포수석을 이탈하거나 아래에 설명
된 상황과 조건에서 투수가 새 공을 요청하는 경우에도 투수에
게 투수판 이탈이 부과될 수 있다. 주자가 없을 때 투수가 투수
판에서 발을 빼는 경우에는 투수판 이탈이 부과되지 않는다. 다
만, 이때 심판이 타임을 부여한 상황이 아니라면 주자가 없을
때 발을 빼도 피치클락의 시간을 처음부터 재시작하지 않는다.
a. 투수판 이탈시 피치클락 설정
최소 한 명의 주자가 루상에 있는 경우 투수의 투수판 이탈
직후 계측을 종료한다(빈 화면 송출).
인플레이 상황에서 타자가 타석에 위치할 때 투수판 이탈이
발생할 경우 투수가 공을 소유하고, 포수와 타자가 더트써클
안에 위치하면 25초(주자 있을 때) 또는 20초(주자 없을 때)
계측을 재시작한다.
투수의 견제 시늉 또는 발을 빼는 행위 이후 주자에 대한 견
제 시도가 없다면 즉시 25초 계측을 재시작한다.


b. 투수판 이탈 허용 횟수 : 3회
투수가 투수판에서 발을 빼는 행위를 통해 피치클락 규정의
적용을 회피하는 것을 방지하기 위해, 주자가 루상에 있고
진행 중인 타석 동안 진루한 사실이 없다면, 투수에게는 타
석당 세 번의 투수판 이탈이 허용된다. 어떠한 이유로든 한
주자가 다른 베이스로 진루하였다면(다른 주자들이 진루하
지 않았더라도) 투수의 투수판 이탈 횟수는 초기화된다(즉,
투수는 동일 타석에서 투수판 이탈을 하지 않았던 것으로 간
주). 투수판 이탈 횟수는 도루실패, 견제, 투수교체, 서스펜
디드 경기 등 다른 어떠한 이유로는 초기화되지 않는다.
c. 동일 타석에서 네 번 이상의 투수판 이탈시
투수가 동일 타석에서 네 번 이상의 투수판 이탈을 기록할
수는 있으나, 해당 플레이 결과로 수비팀에게 다음과 같은
제재가 부과될 수 있다.
(i) 모든 주자가 안전하게 본래의 베이스로 귀루한 경우 :
투수가 네 번 이상의 투수판 이탈을 기록하고 모든 주자
가 본래 점유하던 베이스로 안전하게 귀루(또는 점유 상
태 유지)하면, 투수에게 보크가 선언된다.
(ii) 투수판 이탈의 결과로 수비팀이 아웃을 기록한 경우 :
투수가 네 번 이상의 이탈을 기록하고 수비팀이 하나 이
상의 주자 아웃을 기록하면, 투수에게 보크가 선언되지
않는다.
(iii) 투수판 이탈의 결과로 최소 하나 이상의 주자가 진루한
경우 : 투수가 네 번 이상의 이탈을 기록하고 하나 이상
의 주자가 진루하면(다른 주자들은 진루하지 못하더라
도), 투수에게 보크가 선언되지 않는다.
(iv) 투수판 이탈 횟수 초기화
투수가 네 번 이상의 이탈을 기록한 경우 적어도 하나


이상의 주자가 진루하였을 때만 투수판 이탈이 초기화
된다(투수가 네 번보다 적은 투수판 이탈을 기록하고
주자가 진루한 경우에도 동일한 규칙이 적용됨).
d. 수비팀의 타임 요청
수비팀(투수, 포수 및 수비수)에서 심판에게 타임을 요청하
여 받아들여지면 투수에게 투수판 이탈이 부과된다. 또한,
부상, 구장 내의 외부 물질(불펜이나 관중석에서 날아온 물
체 등)에 의한 타임 요청 또는 공식야구규칙 5.09(c) “ 어필
플레이 ” 에 따라 어필하기 위해 투수가 투수판에서 발을 뺀
경우에는 이탈로 선언되지 않는다.
e. 수비 사인
수비 사인을 보내기 위해 포수가 포수석을 이탈하는 경우 타
자가 타석에 입장해 타격준비자세를 취하기 전(피치클락의
잔여시간이 9초가 남은 시점까지) 포수가 포수석을 떠났다
면, 투수의 투수판 이탈로 간주되지 않는다. 이 때 계시원은
타이머 재설정 여부와 재설정 방법을 다음과 같이 결정해야
한다.
(i) 포수가 타석간 33초 또는 투구간 25초 계측 중 수비 사인
을 보내기 위해 포수석을 벗어났다면, 계측을 종료(빈 화
면 송출)하고, 투수가 공을 소유하고 포수가 위치로 복귀
하기 시작할 때 피치클락을 25초로 재설정해야 한다.
전술한 내용에도 불구하고 포수가 위치로 복귀하기 시작
하고 투수가 공을 소유하고 있을 때 피치클락의 잔여시간
이 25초 보다 많이 남아있을 때에는 타이머를 재설정하
지 않는다.
(ii) 포수가 투수교체 도중 수비 사인을 보내기 위해 포수석
을 벗어났다면, 주자가 있는 상태에서만 투수의 마지막
연습투구가 끝나면 계측을 종료(빈 화면 송출)하고, 투수


가 공을 소유하고 포수가 위치로 복귀하기 시작할 때 피
치클락을 25초로 재설정한다.
전술한 내용에도 불구하고 포수가 위치로 복귀하기 시작
하고 투수가 공을 소유한 시점에 피치클락의 잔여시간이
25초 보다 많이 남아있을 때에는 타이머를 재설정하지
않는다.
f. 새 공 교환 요청
투수의 새 공 교환 요청은 피치클락의 잔여시간이 9초 이상
남았을 때 이루어져야 한다. 피치클락의 잔여시간이 9초 미
만 남은 상황에서는 심판의 승인을 받은 후 새 공 교환 요청
을 할 수 있다.
그러나 퓨처스리그에서는 피치클락의 잔여시간이 9초 미만
의 시간이 남아있을 때의 새 공 교환 요청은 투수판 이탈로
간주된다.

[주] 투수의 적절한 새 공 교환 요청이 이루어졌거나 심판의
볼보이/걸 등에 대한 추가 공 요청이 있었을 경우 심판
이 피치클락의 잔여시간이 25초(주자 있을 때) 또는 20
초(주자 없을 때) 미만이 남아있을 때 이를 완료하면 피
치클락은 재설정되어야 한다. 이 경우 투수가 공을 소유
한 채 마운드 흙 위에 위치하거나 플레이를 재개할 준비
를 완료하고, 포수와 타자가 더트써클에 위치할 때 25초
(주자 있을 때) 또는 20초(주자 없을 때)로 재설정해야
한다.
② 마운드 방문
a. 마운드 방문 시간 : 30초
마운드 방문시 피치클락은 30초로 설정되며, 감독 또는 코치
가 덕아웃을 떠나거나 또는 포수가 더트써클을 벗어나고(포
수와 상의하기 위해 마운드를 벗어난 투수 포함), 심판이 마


운드 방문을 위한 타임 요청을 받아들였을 때 계측을 시작한
다. 주심은 피치클락의 잔여시간이 9초가 되면 마운드로 향
해 준비한다. 감독 또는 코치가 투수교체 신호를 보내지 않
으면 투수를 제외한 마운드 방문 인원은 피치클락이 만료되
기 전에 마운드를 떠나야 한다. 감독 또는 코치가 피치클락
이 만료되는 시점까지 마운드를 떠나지 않거나 투수교체 신
호를 보내지 않는다면, 주심은 마운드 방문을 중단하고 투수
를 제외한 마운드 방문 인원에게 제자리로 복귀하거나 투수
교체 신호를 보낼 것을 지시해야 한다.

[주] 감독 또는 코치가 이미 진행 중인 마운드 방문에 합류하
는 경우 감독·코치가 벤치에서 나올 때 피치클락의 잔
여시간이 25초 미만이 남아있으면 피치클락은 재설정된
다.
b. 투수를 교체하지 않는 경우
마운드 방문 도중 투수교체가 이루어지지 않는 경우 감독 또
는 코치, 포수가 방문을 마치고 마운드 흙을 떠날 때 계측이
종료된다(빈 화면 송출). (공식야구규칙 5.10(l) 참조) 투수
가 공을 소유한 채 마운드 흙 위에 위치하거나 플레이를 재
개할 준비를 완료하고, 포수와 타자가 더트써클에 위치하며,
경기가 재개될 준비가 되었을 때, 25초(주자 있을 때) 또는
20초(주자 없을 때) 계측이 시작된다.
c. 투수를 교체하는 경우
마운드 방문 도중 감독 또는 코치가 투수교체 신호를 보내는
경우 계측이 종료되고 투수교체 시간 계측이 시작된다. 이
때, 감독 또는 코치는 교체 시간 동안 계속해서 마운드에 머
무를 수 있다.
d. 이닝 교대 및 투수교체 중 투수와 포수의 대화
포수는 피치클락의 잔여시간이 9초가 남은 시점까지만 포수


석에 복귀한다면, 별도의 제재 없이 이닝 교대 및 투수교체
시간 동안 마운드에서 투수와 대화할 수 있다. 투수와 대화
하기 위해 추가적인 시간이 필요한 경우 포수는 마운드 방문
(또는 이미 진행 중인 방문의 연장)을 위해 타임을 요청할
수 있다. 포수가 이를 위해 타임을 요청하는 경우 수비팀은
이닝 교대 또는 투수교체 시간을 위반한 것은 아니지만 마운
드 방문 횟수는 차감된다.
e. 부상 관련 마운드 방문시
투수가 타구에 맞았거나 부상이 발생했을 경우 마운드에 올
라가는 것은 마운드 방문 횟수에 포함되지 않으며 마운드 방
문 계측을 하지 않는다.
f. 심판 재량을 통한 추가 시간 부여
주심은 신체적 질병이나 기타 특수한 상황(예 : 만성 무릎 통
증, 호흡기 질환, 선수의 통역 요청)으로 감독 또는 코치의
마운드 방문 시간이 지연되는 경우 재량으로 짧은 추가 시간
을 부여할 수 있다.
③ 본 피치클락 규정은 비디오 판독의 대상이 아니다.
④ 볼 데드 상황
심판이 타임을 선언하거나 볼 데드 상황이 발생하면 계측은 종
료된다(빈 화면 송출). 이후 (a) 투수가 공을 소유한 채 마운드
흙 위에 위치하거나 플레이를 재개할 준비를 완료하고, (b) 포
수와 타자가 더트써클에 위치하며, (c) 모든 야수가 제자리에
위치하고, (d) 모든 주자가 원래의 베이스로 복귀하여, (e) 경기
가 재개될 준비가 되었을 때 피치클락 25초(주자 있을 때) 또는
20초(주자 없을 때)로 재설정한다.
⑤ 연습투구
a. 투수는 이닝 교대 또는 투수교체가 완료될 때까지 원하는 만
큼의 연습투구를 할 수 있다. 그러나 이닝 교대 또는 투수교


체 시간이 33초가 남은 시점까지 마지막 연습투구 동작에 들
어가야 한다. 피치클락이 40초 남아있는 시점에서 투수가 연
습투구를 마치지 않았다면 심판은 수신호로 마지막 연습투
구라는 최종 시그널을 준다.
b. 위반에 따른 제재
특수한 상황이 발생해 추가적인 연습투구가 필요하다고 심
판이 판단하지 않는 한, 심판은 피치클락에 33초가 남았을
때 투수가 연습투구를 던지는 것을 멈추도록 지시해야 한다.
투수가 심판의 지시를 무시하고 남은 이닝 교대 또는 투수교
체 시간이 33초 미만인 상태에서 추가 연습투구를 시도하면
투수의 피치클락 규정 위반으로 볼을 선언한다.
⑥ 타자의 타임 요청
a. 타자의 타임 횟수 제한 : 타석당 2회(퓨처스리그 1회)
각 타석에서 타자는 두 번까지 타임을 요청하여 수락 받을
수 있으며 요청은 구두로 이루어져야 한다.
b. 타임이 선언되면 계측은 종료되고(빈 화면 송출), 투수가 공
을 소유하고 타자가 타석에 복귀하면 피치클락을 25초(주자
있을 때) 또는 20초(주자 없을 때)로 재설정한다. 전술한 내
용에도 불구하고 타자가 타석 복귀를 고의로 지연한다고 판
단될 경우 심판은 계측을 시작하라는 신호를 보낼 수 있다.
c. 위반에 따른 제재
한 타석에서 타자의 타임 요청이 세 번 이상 이루어진 경우
심판은 자동 스트라이크를 선언한다(퓨처스리그 두 번). 단,
타자가 세 번 이상 타임을 요청하였더라도 타석을 벗어나지
않았다면, 심판은 스트라이크를 선언하지 않고 타임 요청을
거부할 수 있다.
⑦ 구장 내 행사 관련
a. 그라운드 내 행사 등으로 이닝 교대 시간이 연장되는 경우


피치클락은 해당 행사가 종료된 이후에 계측이 시작된다. 이
닝 교대 시간이 연장되는 그라운드 내 행사는 총재의 사전
승인을 받아야 한다.
b. 그라운드 내 행사를 포함한 여타 구장 내 행사가 선수의 피
치클락 규칙 준수 및 원활한 경기운영을 방해하지 않도록 관
리할 책임은 홈구단에게 있다. 구단이 이를 준수하지 않을
경우 제재의 대상이 된다.
⑧ 심판이 공을 교환하거나 홈 플레이트를 닦는 등 경기관리 활동
을 수행하는 경우 심판의 작업이 피치클락의 잔여시간이 25초
(주자 있을 때) 또는 20초(주자 없을 때) 미만이 남아있을 때
완료되면 피치클락을 재설정해야 한다. 이 경우 투수가 공을 소
유한 채 마운드 흙 위에 위치하거나 플레이를 재개할 준비를 완
료하고, 포수와 타자가 더트써클 안에 위치하고 있으며, 경기가
재개될 준비가 되었을 때 25초 또는 20초로 재설정한다.
⑨ 불가피한 상황으로 인한 경기 지연 발생시(예 : 부상 또는 기타
응급 상황 발생, 장비 관련 문제 발생, 경기장 또는 경기장 근무
인원 관련 문제 발생, 타자가 투구된 공을 피하기 위해 넘어지
는 등 타석을 벗어난 경우, 주자가 베이스에서 물러나 그라운드
에서 나오고 있는 경우, 그라운드 내 파울 볼을 회수하는 경우,
심판의 경기운영·관리 활동, 심판과 대화하기 위해 감독이 그
라운드에 나온 경우 등), 계시원은 심판의 판단에 따라 경기재
개 준비가 완료될 때까지 계측 시작을 지연해야 한다.
만약 플레이가 재개될 준비가 완료되기에 앞서 계측이 먼저 시
작된 것으로 심판이 판단하는 경우 심판은 계시원에게 신호하
여 피치클락의 시간을 재설정할 수 있다. 이 경우 투수가 공을
소유하고, 포수와 타자가 더트써클 안에 위치하고 있으며, 경기
가 재개될 준비가 되었을 때 25초 또는 20초로 재설정한다.


3. 기타
① 심판의 권한
본 규정은 공식야구규칙에 따라 경기를 운영·관리하는 심판의
의무와 권한을 변경·제한하지 않는다. 심판은 경기의 운영·
관리에 필요한 결정을 내릴 책임과 권한이 있으며, 본 규정에서
구체적으로 다루지 않고 있는 사항에 대해 판정할 권한이 있다.
심판의 권한에 따라 심판은 피치클락의 계측을 시작, 종료 또는
재설정하도록 계시원에게 지시하거나, 피치클락의 계측 시작,
종료 또는 재설정 시기에 관한 계시원의 결정 또는 오류를 철회
하거나 수정할 수 있다. 예컨대 심판은 재량에 따라 특수 상황
에 따른 조정을 결정할 수 있다(예 : 이닝의 첫 타자가 외야수
또는 포수인 경우, 루상에서 이닝을 마친 포수가 장비 착용 시
간이 충분하지 않거나, 부상 또는 의학적 문제로 선수에게 추가
적인 시간이 필요한 경우). 이러한 특수 상황이 발생했거나 또
는 플레이가 재개될 준비가 완료되기에 앞서 계측이 먼저 시작
되었다고 심판이 판단하는 경우 심판은 계시원에게 신호하여
피치클락의 시간을 재설정할 수 있다. 이때 심판은 경기가 재개
될 준비가 되었을 때 25초(주자 있을 때) 또는 20초(주자 없을
때)로 재설정하도록 신호를 보내야 한다.
계시원이 피치클락을 규정에 맞게 운영하지 않았다고 판단되는
상황에서는 플레이 중 피치클락 규정 위반이 발생했음에도 불
구하고 심판의 판단에 따라 제재를 부과하지 않는 것으로 결정
할 수 있다.
피치클락 규정의 운영에 관한 심판의 결정은 최종적이며 양 구
단 모두에 대해 구속력을 지닌다. 본 규정에 따른 심판의 결정
에 대해 항의하거나 이의를 제기하는 경우 해당 당사자에게 퇴
장을 선언한다.


② 장비 오류 발생시
외야 피치클락 또는 두 개의 내야 피치클락에 모두 오류가 나면
모든 피치클락의 작동을 중단하고 본 규정의 제재 적용 없이 경
기를 진행한다. 단, (a) 외야 피치클락과 두 개의 내야 피치클락
중 하나가 작동하는 경우 피치클락은 본 규정에 따라 운영되며
제재 역시 부과된다. 또한, (b) 피치클락의 수리가 경기 도중 완
료되면 다음 회 초가 시작될 때 피치클락의 사용과 제재 적용을
재개할 수 있다.
③ 구단은 본 규정의 사본을 구단의 전광판 담당자 및 장내 아나운
서 등 유관 담당자에게 배포해야 한다.
④ 공식야구규칙 5.04(b)(4) “ 타자석 규칙 ” 을 포함하여 본 피치클
락 규정과 상충되는 야구규칙은 적용하지 않는다.

## 부록 (KBO 리그 규정)
|부록|Col2|Col3|
|---|---|---|
|구분|KBO 리그|퓨처스리그|
|투수교체 시간|2분 10초|2분 10초|
|이닝 교대 시간|2분 10초|2분 10초|
|타석간 시간 이닝 교체, 투수교체시 마지막 준비 투구 실시|33초|30초|
|주자 있을시 투구 시간|25초|23초|
|주자 없을시 투구 시간|20초|18초|
|포수는 9초가 표기된 시점에 포수석에 위치하고 있어야 함|9초|9초|
|타자는 8초가 표기된 시점에 타석에 들어서 타격준비를 완료해야 함|8초|8초|
|투수는 피치클락이 만료되기 전까지 타자에게 투구하는 자연스러운 동작을 시작해야 함|0초|0초|



(2024.1.24 ➜ 2025.1.14 개정)
...
#### 제11조 KBO 기록상 및 KBO 기념상 (KBO 표창규정)
